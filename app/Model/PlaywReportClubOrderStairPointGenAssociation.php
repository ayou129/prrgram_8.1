...
class PlaywReportClubOrderStairPointGenAssociation extends BaseModel
{
     ...
     */
    protected ?string $table = 'playw_report_club_order_stair_point_gen_associations';

    /**
     * The attributes that are mass assignable.
     */
    protected array $fillable = ['id', 'club_id', 'stair_point_id', 'playw_u_id', 'point_method_fixed', 'point_method_ratio', 'created_at', 'updated_at', 'deleted_at'];

    /**
     * The attributes that should be cast to native types.
     */
    protected array $casts = ['id' => 'integer', 'club_id' => 'integer', 'stair_point_id' => 'integer', 'playw_u_id' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];

 ...
 * @property null|\Hyperf\Database\Model\Collection|PlaywReportClubOrderStairPointRule[] $rule
 * @property null|\Hyperf\Database\Model\Collection|PlaywReportClubOrderStairPointExcludeUser[] $excludeUsers
 * @property null|\Hyperf\Database\Model\Collection|PlaywReportClubOrderStairPointExcludeProject[] $excludeProjects
 */
class PlaywReportClubOrderStairPoint extends BaseModel
{
     ...
     */
    protected ?string $table = 'playw_report_club_order_stair_point';

    /**
     * The attributes that are mass assignable.
     */
    protected array $fillable = ['id', 'club_id', 'period_type', 'status', 'created_at', 'updated_at', 'deleted_at'];

    /**
     * The attributes that should be cast to native types.
     */
    protected array $casts = ['id' => 'integer', 'club_id' => 'integer', 'period_type' => 'integer', 'status' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];
